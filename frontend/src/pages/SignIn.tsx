      ...
      <div className="relative w-full max-w-md bg-black/50 backdrop-blur-lg rounded-2xl border border-gray-700/50 shadow-2xl shadow-red-500/10">
        <div className="p-8">
          ...
          <form className="space-y-6">
            {/* ... (form fields are the same) ... */}
             <div>
              ...
              <input type="text" id="username" className="mt-1 block w-full bg-gray-900/50 border border-gray-700 rounded-lg py-3 px-4 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition duration-300" placeholder="your_username"/>
            </div>
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-gray-400">Password</label>
              <input type="password" id="password" className="mt-1 block w-full bg-gray-900/50 border border-gray-700 rounded-lg py-3 px-4 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition duration-300" placeholder="••••••••"/>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-8">
            ...
            {/* v-- This is the important change v-- */}
