...
const Dashboard = () => {
  return (
    <div className="min-h-screen bg-black font-sans text-gray-300">
      {/* Animated Background Blobs are fixed and behind everything */}
      ...
      {/* The Navbar is rendered here, and its "sticky" property will keep it fixed at the top */}
      <Navbar />
      
      <div className="flex">
        {/* The desktop sidebar is fixed to the left side of the screen */}
        ...
        {/* The main content area now has padding on the left to avoid the sidebar */}
        <main className="flex-grow lg:pl-64"> {/* Padding left for sidebar */}
