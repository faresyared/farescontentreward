  ...
  return (
    <div className="min-h-screen bg-black font-sans text-gray-300">
      ...
      <div className="flex justify-center pt-4 md:pt-10">
        <img className="h-20 w-20 rounded-full border-2 border-red-500/50" src="profile-photo-url" alt="User avatar" />
      </div>
      ...
      {/* Main content */}
      <main className="pt-16 lg:pl-64 pt-28"> {/* Increased padding-top for mobile layout */}
