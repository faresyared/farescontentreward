...
const Navbar = () => {
  ...
  return (
    // The Fragment is no longer needed but kept for safety.
    <>
      <nav className="sticky top-0 z-40 bg-black/70 backdrop-blur-xl border-b border-gray-800/50">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              <NavLink to="/dashboard/home" className="flex items-center flex-shrink-0">
                <img className="h-8 w-auto" src="/logo.png" alt="Reelify Logo" />
                <span className="ml-3 text-2xl font-bold text-red-500">Reelify</span>
              </NavLink>
