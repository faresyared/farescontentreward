  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-gray-900/50 rounded-xl">
        ...
        {/* --- THIS IS THE FIX --- */}
        {/* We use ReactMarkdown to render the rules. The 'prose' and 'prose-invert' classes from Tailwind
            provide beautiful default styling for lists, bold text, links, etc. */}
